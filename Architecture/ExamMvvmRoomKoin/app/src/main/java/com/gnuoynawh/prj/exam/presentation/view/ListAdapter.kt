package com.gnuoynawh.prj.exam.presentation.view
...
class ListAdapter: RecyclerView.Adapter<ListAdapter.MyViewHolder>() {
    ...
    private lateinit var onItemUpdateListener: (file: File) -> Unit
    private lateinit var onItemDeleteListener: (file: File) -> Unit

    // ViewHolder 생성
    inner class MyViewHolder(
        private val binding: RowFilesBinding,
        val onItemClickListener: (file: File) -> Unit,
        val onItemUpdateListener: (file: File) -> Unit,
        val onItemDeleteListener: (file: File) -> Unit
    ...
    fun setData(
        fileList: List<File>,
        onItemClickListener: (file: File) -> Unit,
        onItemUpdateListener: (file: File) -> Unit,
        onItemDeleteListener: (file: File) -> Unit
    ) {
