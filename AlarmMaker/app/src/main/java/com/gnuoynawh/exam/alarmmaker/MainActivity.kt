package com.gnuoynawh.exam.alarmmaker
...
class MainActivity : AppCompatActivity() {
    ...
    val onetimeAlarmToggle by lazy {
        findViewById<ToggleButton>(R.id.onetimeAlarmToggle)
    }
    val periodicAlarmToggle by lazy {
        findViewById<ToggleButton>(R.id.periodicAlarmToggle)
    }
    val exactPeriodicAlarmToggle by lazy {
        findViewById<ToggleButton>(R.id.exactPeriodicAlarmToggle)
    }
    val realtimePeriodicAlarmToggle by lazy {
        findViewById<ToggleButton>(R.id.realtimePeriodicAlarmToggle)
    }
